//[app](../../../index.md)/[com.qwict.studyplanetandroid.data.local](../index.md)/[StudyPlanetDatabase](index.md)

# StudyPlanetDatabase

[androidJvm]\
abstract class [StudyPlanetDatabase](index.md) : [RoomDatabase](https://developer.android.com/reference/kotlin/androidx/room/RoomDatabase.html)

Room Database for the Study Planet application, managing entities such as [PlanetRoomEntity](../../com.qwict.studyplanetandroid.data.local.schema/-planet-room-entity/index.md) and [UserRoomEntity](../../com.qwict.studyplanetandroid.data.local.schema/-user-room-entity/index.md).

## Constructors

| | |
|---|---|
| [StudyPlanetDatabase](-study-planet-database.md) | [androidJvm]<br>constructor() |
...
| [planetDao](planet-dao.md) | [androidJvm]<br>abstract fun [planetDao](planet-dao.md)(): [PlanetDao](../../com.qwict.studyplanetandroid.data.local.dao/-planet-dao/index.md) |
...
| [userDao](user-dao.md) | [androidJvm]<br>abstract fun [userDao](user-dao.md)(): [UserDao](../../com.qwict.studyplanetandroid.data.local.dao/-user-dao/index.md) |
